    ...
    namespace VOI_DAQ
{
    class DAQ
    {
        ...
        public static UInt16 SIZE_OF_ARRAY = 5000;

        //   public static  UInt16 MAX_ARRAY_SIZE = 500;
        //   public static UInt16  MAX_ARRAY = 499;

        public static string[] Index_Arr = new string[SIZE_OF_ARRAY];
        public static string[] Speed_Arr = new string[SIZE_OF_ARRAY];
        public static string[] Voltage_Arr = new string[SIZE_OF_ARRAY];
        public static string[] Current_Arr  = new string[SIZE_OF_ARRAY];
        public static string[] Power_Arr = new string[SIZE_OF_ARRAY];
        public static string[] Temperature_Arr = new string[SIZE_OF_ARRAY];
